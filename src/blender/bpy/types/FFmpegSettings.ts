...
export class FFmpegSettings {
   ...
   */
  public get constant_rate_factor():
    | 'NONE'
    | 'LOSSLESS'
    | 'PERC_LOSSLESS'
    | 'HIGH'
   ...
   * @desc enum in ['NONE', 'LOSSLESS', 'PERC_LOSSLESS', 'HIGH', 'MEDIUM', 'LOW', 'VERYLOW', 'LOWEST'], default 'MEDIUM'
   */
  public set constant_rate_factor(
    value: 'NONE' | 'LOSSLESS' | 'PERC_LOSSLESS' | 'HIGH' | 'MEDIUM' | 'LOW' | 'VERYLOW' | 'LOWEST'
  ) {
   ...
   */
  public set format(
    value: 'MPEG1' | 'MPEG2' | 'MPEG4' | 'AVI' | 'QUICKTIME' | 'DV' | 'OGG' | 'MKV' | 'FLASH' | 'WEBM'
  ) {
