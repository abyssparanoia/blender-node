...
export class Brush {
  ...
  public get image_paint_capabilities(): BrushCapabilitiesImagePaint {
    return PythonInterop.getClass(
      this.interop,
      `${this.accessor}.image_paint_capabilities`,
  ...
  public get vertex_paint_capabilities(): BrushCapabilitiesVertexPaint {
    return PythonInterop.getClass(
      this.interop,
      `${this.accessor}.vertex_paint_capabilities`,
  ...
  public get weight_paint_capabilities(): BrushCapabilitiesWeightPaint {
    return PythonInterop.getClass(
      this.interop,
      `${this.accessor}.weight_paint_capabilities`,
   ...
   * @desc enum in ['CUSTOM', 'SMOOTH', 'SMOOTHER', 'SPHERE', 'ROOT', 'SHARP', 'LIN', 'POW4', 'INVSQUARE', 'CONSTANT'], default 'CUSTOM'
   */
  public set curve_preset(
    value: 'CUSTOM' | 'SMOOTH' | 'SMOOTHER' | 'SPHERE' | 'ROOT' | 'SHARP' | 'LIN' | 'POW4' | 'INVSQUARE' | 'CONSTANT'
  ) {
