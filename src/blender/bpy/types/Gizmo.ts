...
export class Gizmo {
   ...
   * @desc void
   */
  public draw_preset_box(options: {
    matrix?: [
      [number, number, number, number],
      [number, number, number, number],
      [number, number, number, number],
   ...
   * @desc void
   */
  public draw_preset_arrow(options: {
    matrix?: [
      [number, number, number, number],
      [number, number, number, number],
      [number, number, number, number],
   ...
   * @desc void
   */
  public draw_preset_circle(options: {
    matrix?: [
      [number, number, number, number],
      [number, number, number, number],
      [number, number, number, number],
