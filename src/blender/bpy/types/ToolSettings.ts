...
export class ToolSettings {
   ...
   */
  public get proportional_edit_falloff():
    | 'SMOOTH'
    | 'SPHERE'
    | 'ROOT'
    | 'INVERSE_SQUARE'
   ...
   */
  public get transform_pivot_point():
    | 'BOUNDING_BOX_CENTER'
    | 'CURSOR'
    | 'INDIVIDUAL_ORIGINS'
    | 'MEDIAN_POINT'
   ...
   * @desc enum in ['SMOOTH', 'SPHERE', 'ROOT', 'INVERSE_SQUARE', 'SHARP', 'LINEAR', 'CONSTANT', 'RANDOM'], default 'SMOOTH'
   */
  public set proportional_edit_falloff(
    value: 'SMOOTH' | 'SPHERE' | 'ROOT' | 'INVERSE_SQUARE' | 'SHARP' | 'LINEAR' | 'CONSTANT' | 'RANDOM'
  ) {
   ...
   * @desc enum set in {'INCREMENT', 'VERTEX', 'EDGE', 'FACE', 'VOLUME', 'EDGE_MIDPOINT', 'EDGE_PERPENDICULAR'}, default {'INCREMENT'}
   */
  public set snap_elements(
    value: ('INCREMENT' | 'VERTEX' | 'EDGE' | 'FACE' | 'VOLUME' | 'EDGE_MIDPOINT' | 'EDGE_PERPENDICULAR')[]
  ) {
   ...
   * @desc enum in ['BOUNDING_BOX_CENTER', 'CURSOR', 'INDIVIDUAL_ORIGINS', 'MEDIAN_POINT', 'ACTIVE_ELEMENT'], default 'MEDIAN_POINT'
   */
  public set transform_pivot_point(
    value: 'BOUNDING_BOX_CENTER' | 'CURSOR' | 'INDIVIDUAL_ORIGINS' | 'MEDIAN_POINT' | 'ACTIVE_ELEMENT'
  ) {
