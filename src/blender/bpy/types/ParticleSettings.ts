...
export class ParticleSettings {
   ...
   */
  public get texture_slots(): BlenderCollection<ParticleSettingsTextureSlot> &
    Indexable<ParticleSettingsTextureSlot> &
   ...
   */
  public get angular_velocity_mode():
    | 'NONE'
    | 'VELOCITY'
    | 'HORIZONTAL'
    | 'VERTICAL'
   ...
   * @desc enum in ['NONE', 'VELOCITY', 'HORIZONTAL', 'VERTICAL', 'GLOBAL_X', 'GLOBAL_Y', 'GLOBAL_Z', 'RAND'], default 'NONE'
   */
  public set angular_velocity_mode(
    value: 'NONE' | 'VELOCITY' | 'HORIZONTAL' | 'VERTICAL' | 'GLOBAL_X' | 'GLOBAL_Y' | 'GLOBAL_Z' | 'RAND'
  ) {
   ...
   * @desc enum in ['NONE', 'NOR', 'NOR_TAN', 'VEL', 'GLOB_X', 'GLOB_Y', 'GLOB_Z', 'OB_X', 'OB_Y', 'OB_Z'], default 'NONE'
   */
  public set rotation_mode(
    value: 'NONE' | 'NOR' | 'NOR_TAN' | 'VEL' | 'GLOB_X' | 'GLOB_Y' | 'GLOB_Z' | 'OB_X' | 'OB_Y' | 'OB_Z'
  ) {
