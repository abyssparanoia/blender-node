...
export class NodeTree {
  ...
  /**
   * Node tree inputs
   * @desc NodeTreeInputs bpy_prop_collection of NodeSocketInterface, (readonly)
   */
  public get inputs(): BlenderCollection<NodeSocketInterface> & Indexable<NodeSocketInterface> & NodeTreeInputs {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.inputs`,
      NodeTreeInputs,
      NodeSocketInterface
    )
  }
  ...
  /**
   *
   * @desc NodeLinks bpy_prop_collection of NodeLink, (readonly)
   */
  public get links(): BlenderCollection<NodeLink> & Indexable<NodeLink> & NodeLinks {
    return BlenderCollection.createSpecialized(this.interop, `${this.accessor}.links`, NodeLinks, NodeLink)
  }

  /**
   *
   * @desc Nodes bpy_prop_collection of Node, (readonly)
   */
  public get nodes(): BlenderCollection<Node> & Indexable<Node> & Nodes {
    return BlenderCollection.createSpecialized(this.interop, `${this.accessor}.nodes`, Nodes, Node)
  }

  /**
   * Node tree outputs
   * @desc NodeTreeOutputs bpy_prop_collection of NodeSocketInterface, (readonly)
   */
  public get outputs(): BlenderCollection<NodeSocketInterface> & Indexable<NodeSocketInterface> & NodeTreeOutputs {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.outputs`,
      NodeTreeOutputs,
      NodeSocketInterface
    )
  }
   ...
   * @desc enum in ['SHADER', 'TEXTURE', 'COMPOSITING'], default 'SHADER', (readonly)
   */
  public get type(): 'SHADER' | 'TEXTURE' | 'COMPOSITING' {
   ...
   */
  public get view_center(): [number, number] {
    return PythonInterop.getArray(this.interop, `${this.accessor}.view_center`, 'number', 2)
  }
   ...
   */
  public get active_input(): number {
    return PythonInterop.getInteger(this.interop, `${this.accessor}.active_input`)
  }
   ...
   * @desc int in [0, inf], default 0
   */
  public get active_output(): number {
    return PythonInterop.getInteger(this.interop, `${this.accessor}.active_output`)
  }
   ...
   * @desc int in [0, inf], default 0
   */
  public set active_input(value: number) {
    PythonInterop.setInteger(this.interop, `${this.accessor}.active_input`, value)
  }
   ...
   * @desc int in [0, inf], default 0
   */
  public set active_output(value: number) {
    PythonInterop.setInteger(this.interop, `${this.accessor}.active_output`, value)
  }
   ...
   * @desc void
   */
  public interface_update(): void {
    return PythonInterop.callVoid(this.interop, `${this.accessor}.interface_update`, {})
  }
