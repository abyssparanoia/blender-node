...
export class GizmoGroup {
   ...
   * @desc enum set in {'3D', 'SCALE', 'DEPTH_3D', 'SELECT', 'PERSISTENT', 'SHOW_MODAL_ALL', 'TOOL_INIT'}, default {'3D'}
   */
  public set bl_options(
    value: ('3D' | 'SCALE' | 'DEPTH_3D' | 'SELECT' | 'PERSISTENT' | 'SHOW_MODAL_ALL' | 'TOOL_INIT')[]
  ) {
