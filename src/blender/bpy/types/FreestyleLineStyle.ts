...
export class FreestyleLineStyle {
   ...
   */
  public get alpha_modifiers(): BlenderCollection<LineStyleAlphaModifier> &
    Indexable<LineStyleAlphaModifier> &
    LineStyleAlphaModifiers {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.alpha_modifiers`,
      LineStyleAlphaModifiers,
   ...
   */
  public get color_modifiers(): BlenderCollection<LineStyleColorModifier> &
    Indexable<LineStyleColorModifier> &
    LineStyleColorModifiers {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.color_modifiers`,
      LineStyleColorModifiers,
   ...
   */
  public get geometry_modifiers(): BlenderCollection<LineStyleGeometryModifier> &
    Indexable<LineStyleGeometryModifier> &
    LineStyleGeometryModifiers {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.geometry_modifiers`,
      LineStyleGeometryModifiers,
   ...
   */
  public get texture_slots(): BlenderCollection<LineStyleTextureSlot> &
    Indexable<LineStyleTextureSlot> &
    LineStyleTextureSlots {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.texture_slots`,
      LineStyleTextureSlots,
   ...
   */
  public get thickness_modifiers(): BlenderCollection<LineStyleThicknessModifier> &
    Indexable<LineStyleThicknessModifier> &
    LineStyleThicknessModifiers {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.thickness_modifiers`,
      LineStyleThicknessModifiers,
