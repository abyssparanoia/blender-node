...
export class HookModifier {
   ...
   * @desc enum in ['NONE', 'CURVE', 'SMOOTH', 'SPHERE', 'ROOT', 'INVERSE_SQUARE', 'SHARP', 'LINEAR', 'CONSTANT'], default 'NONE'
   */
  public set falloff_type(
    value: 'NONE' | 'CURVE' | 'SMOOTH' | 'SPHERE' | 'ROOT' | 'INVERSE_SQUARE' | 'SHARP' | 'LINEAR' | 'CONSTANT'
  ) {
   ...
   * @desc void
   */
  public vertex_indices_set(options: {
    indices?: [
      number,
      number,
      number,
