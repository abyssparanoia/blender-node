...
export class Mesh {
   ...
   */
  public get polygon_layers_float(): BlenderCollection<MeshPolygonFloatPropertyLayer> &
    Indexable<MeshPolygonFloatPropertyLayer> &
    PolygonFloatProperties {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.polygon_layers_float`,
      PolygonFloatProperties,
   ...
   */
  public get polygon_layers_int(): BlenderCollection<MeshPolygonIntPropertyLayer> &
    Indexable<MeshPolygonIntPropertyLayer> &
    PolygonIntProperties {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.polygon_layers_int`,
      PolygonIntProperties,
   ...
   */
  public get polygon_layers_string(): BlenderCollection<MeshPolygonStringPropertyLayer> &
    Indexable<MeshPolygonStringPropertyLayer> &
    PolygonStringProperties {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.polygon_layers_string`,
      PolygonStringProperties,
   ...
   */
  public get vertex_layers_float(): BlenderCollection<MeshVertexFloatPropertyLayer> &
    Indexable<MeshVertexFloatPropertyLayer> &
    VertexFloatProperties {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.vertex_layers_float`,
      VertexFloatProperties,
   ...
   */
  public get vertex_layers_int(): BlenderCollection<MeshVertexIntPropertyLayer> &
    Indexable<MeshVertexIntPropertyLayer> &
    VertexIntProperties {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.vertex_layers_int`,
      VertexIntProperties,
   ...
   */
  public get vertex_layers_string(): BlenderCollection<MeshVertexStringPropertyLayer> &
    Indexable<MeshVertexStringPropertyLayer> &
    VertexStringProperties {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.vertex_layers_string`,
      VertexStringProperties,
