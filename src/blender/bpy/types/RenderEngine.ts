...
export class RenderEngine {
   ...
   * @desc void
   */
  public end_result(options: {
    result?: RenderResult
    cancel?: boolean
    highlight?: boolean
    do_merge_results?: boolean
  }): void {
   ...
   */
  public camera_model_matrix(options: {
   ...
   * @desc void
   */
  public register_pass(options: {
    name?: string
    channels?: number
    chanid?: string
    type?: 'VALUE' | 'VECTOR' | 'COLOR'
  }): void {
