...
export class FluidDomainSettings {
   ...
   */
  public get sndparticle_combined_export():
    | 'OFF'
    | 'SPRAY_FOAM'
    | 'SPRAY_BUBBLES'
    | 'FOAM_BUBBLES'
   ...
   * @desc enum in ['OFF', 'SPRAY_FOAM', 'SPRAY_BUBBLES', 'FOAM_BUBBLES', 'SPRAY_FOAM_BUBBLES'], default 'OFF'
   */
  public set sndparticle_combined_export(
    value: 'OFF' | 'SPRAY_FOAM' | 'SPRAY_BUBBLES' | 'FOAM_BUBBLES' | 'SPRAY_FOAM_BUBBLES'
  ) {
