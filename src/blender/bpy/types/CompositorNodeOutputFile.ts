...
export class CompositorNodeOutputFile {
   ...
   */
  public get file_slots(): BlenderCollection<NodeOutputFileSlotFile> &
    Indexable<NodeOutputFileSlotFile> &
    CompositorNodeOutputFileFileSlots {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.file_slots`,
      CompositorNodeOutputFileFileSlots,
   ...
   */
  public get layer_slots(): BlenderCollection<NodeOutputFileSlotLayer> &
    Indexable<NodeOutputFileSlotLayer> &
    CompositorNodeOutputFileLayerSlots {
    return BlenderCollection.createSpecialized(
      this.interop,
      `${this.accessor}.layer_slots`,
      CompositorNodeOutputFileLayerSlots,
