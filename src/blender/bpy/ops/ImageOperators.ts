...
export class ImageOperators {
  ...
  public open(options: {
    ...
    use_sequence_detection?: boolean
    use_udim_detecting?: boolean
  }): void {
   ...
   * @desc void
   */
  public unpack(options: {
    method?: 'REMOVE' | 'USE_LOCAL' | 'WRITE_LOCAL' | 'USE_ORIGINAL' | 'WRITE_ORIGINAL'
    id?: string
  }): void {
   ...
   * @desc void
   */
  public view_zoom_border(options: {
    xmin?: number
    xmax?: number
    ymin?: number
    ymax?: number
