...
export class SequencerOperators {
   ...
   * @desc void
   */
  public change_effect_type(options: {
    type?:
      | 'CROSS'
      | 'ADD'
      | 'SUBTRACT'
  ...
  public duplicate_move(options: {
    SEQUENCER_OT_duplicate?: SEQUENCER_OT_duplicate
    TRANSFORM_OT_seq_slide?: TRANSFORM_OT_seq_slide
  }): void {
   ...
   * @desc void
   */
  public effect_strip_add(options: {
    frame_start?: number
    frame_end?: number
    channel?: number
    replace_sel?: boolean
   ...
   * @desc void
   */
  public export_subtitles(options: {
    filepath?: string
    hide_props_region?: boolean
   ...
   * @desc void
   */
  public fades_add(options: {
    duration_seconds?: number
    type?: 'IN_OUT' | 'IN' | 'OUT' | 'CURSOR_FROM' | 'CURSOR_TO'
  }): void {
   ...
   * @desc void
   */
  public image_strip_add(options: {
    directory?: string
    files?: any
    filter_blender?: boolean
    filter_backup?: boolean
    ...
    filemode?: number
    relative_path?: boolean
    show_multiview?: boolean
    use_multiview?: boolean
    display_type?: 'DEFAULT' | 'LIST_VERTICAL' | 'LIST_HORIZONTAL' | 'THUMBNAIL'
    sort_method?: 'FILE_SORT_ALPHA' | 'FILE_SORT_EXTENSION' | 'FILE_SORT_TIME' | 'FILE_SORT_SIZE'
    frame_start?: number
    frame_end?: number
   ...
   * @desc void
   */
  public movieclip_strip_add(options: {
    frame_start?: number
    channel?: number
    replace_sel?: boolean
    overlap?: boolean
   ...
   * @desc void
   */
  public scene_strip_add(options: {
    frame_start?: number
    channel?: number
    replace_sel?: boolean
    overlap?: boolean
  ...
  public select(options: {
    wait_to_deselect_others?: boolean
    mouse_x?: number
    mouse_y?: number
    extend?: boolean
    deselect_all?: boolean
    linked_handle?: boolean
    left_right?: 'NONE' | 'MOUSE' | 'LEFT' | 'RIGHT'
    linked_time?: boolean
  }): void {
  ...
  public select_grouped(options: {
    type?: 'TYPE' | 'TYPE_BASIC' | 'TYPE_EFFECT' | 'DATA' | 'EFFECT' | 'EFFECT_LINK' | 'OVERLAP'
    extend?: boolean
    use_active_channel?: boolean
  }): void {
   ...
   * @desc void
   */
  public sound_strip_add(options: {
    filepath?: string
    files?: any
    filter_blender?: boolean
    filter_backup?: boolean
   ...
   * @desc void
   */
  public strip_modifier_add(options: {
    type?: 'COLOR_BALANCE' | 'CURVES' | 'HUE_CORRECT' | 'BRIGHT_CONTRAST' | 'MASK' | 'WHITE_BALANCE' | 'TONEMAP'
  }): void {
   ...
   * @desc void
   */
  public view_ghost_border(options: {
    xmin?: number
    xmax?: number
    ymin?: number
    ymax?: number
