...
export class CurveOperators {
  ...
  public duplicate_move(options: {
    CURVE_OT_duplicate?: CURVE_OT_duplicate
  ...
  public extrude_move(options: {
    CURVE_OT_extrude?: CURVE_OT_extrude
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public handle_type_set(options: {
    type?: 'AUTOMATIC' | 'VECTOR' | 'ALIGNED' | 'FREE_ALIGN' | 'TOGGLE_FREE_ALIGN'
  }): void {
   ...
   * @desc void
   */
  public primitive_bezier_circle_add(options: {
    radius?: number
   ...
   * @desc void
   */
  public primitive_bezier_curve_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_circle_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_curve_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_path_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
  ...
  public select_similar(options: {
    type?: 'TYPE' | 'RADIUS' | 'WEIGHT' | 'DIRECTION'
