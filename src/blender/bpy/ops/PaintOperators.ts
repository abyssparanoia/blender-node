...
export class PaintOperators {
   ...
   * @desc void
   */
  public add_texture_paint_slot(options: {
    type?: 'BASE_COLOR' | 'SPECULAR' | 'ROUGHNESS' | 'METALLIC' | 'NORMAL' | 'BUMP' | 'DISPLACEMENT'
    name?: string
    width?: number
    height?: number
  ...
  public brush_select(options: {
    sculpt_tool?:
      ...
      | 'SIMPLIFY'
      | 'MASK'
    vertex_tool?: 'DRAW' | 'BLUR' | 'AVERAGE' | 'SMEAR'
    weight_tool?: 'DRAW' | 'BLUR' | 'AVERAGE' | 'SMEAR'
    image_tool?: 'DRAW' | 'SOFTEN' | 'SMEAR' | 'CLONE' | 'FILL' | 'MASK'
   ...
   * @desc void
   */
  public hide_show(options: {
    action?: 'HIDE' | 'SHOW'
    area?: 'OUTSIDE' | 'INSIDE' | 'ALL' | 'MASKED'
    xmin?: number
    xmax?: number
    ymin?: number
    ymax?: number
   ...
   * @desc void
   */
  public mask_lasso_gesture(options: {
    path?: string
    mode?: 'VALUE' | 'VALUE_INVERSE' | 'INVERT'
    value?: number
  }): void {
   ...
   * @desc void
   */
  public vertex_color_dirt(options: {
   ...
   * @desc void
   */
  public weight_gradient(options: {
    type?: 'LINEAR' | 'RADIAL'
    xstart?: number
    xend?: number
    ystart?: number
