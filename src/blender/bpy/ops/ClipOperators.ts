...
export class ClipOperators {
   ...
   * @desc void
   */
  public add_marker_move(options: {
    CLIP_OT_add_marker?: CLIP_OT_add_marker
   ...
   * @desc void
   */
  public add_marker_slide(options: {
    CLIP_OT_add_marker?: CLIP_OT_add_marker
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public camera_preset_add(options: {
    name?: string
    remove_name?: boolean
    remove_active?: boolean
    use_focal_length?: boolean
  }): void {
   ...
   * @desc void
   */
  public clean_tracks(options: {
    frames?: number
    error?: number
    action?: 'SELECT' | 'DELETE_TRACK' | 'DELETE_SEGMENTS'
  }): void {
   ...
   * @desc void
   */
  public detect_features(options: {
   ...
   * @desc void
   */
  public graph_select_box(options: {
    xmin?: number
    xmax?: number
    ymin?: number
    ymax?: number
  ...
  public select_grouped(options: {
    group?: 'KEYFRAMED' | 'ESTIMATED' | 'TRACKED' | 'LOCKED' | 'DISABLED' | 'COLOR' | 'FAILED'
  }): void {
   ...
   * @desc void
   */
  public tracking_settings_preset_add(options: {
    name?: string
    remove_name?: boolean
    remove_active?: boolean
  }): void {
