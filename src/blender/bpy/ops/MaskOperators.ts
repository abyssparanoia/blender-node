...
export class MaskOperators {
   ...
   * @desc void
   */
  public add_feather_vertex_slide(options: {
    MASK_OT_add_feather_vertex?: MASK_OT_add_feather_vertex
    MASK_OT_slide_point?: MASK_OT_slide_point
  }): void {
   ...
   * @desc void
   */
  public add_vertex_slide(options: {
    MASK_OT_add_vertex?: MASK_OT_add_vertex
    MASK_OT_slide_point?: MASK_OT_slide_point
  }): void {
  ...
  public duplicate_move(options: {
    MASK_OT_duplicate?: MASK_OT_duplicate
