...
export class AnimOperators {
   ...
   * @desc void
   */
  public channels_editable_toggle(options: {
    mode?: 'TOGGLE' | 'DISABLE' | 'ENABLE' | 'INVERT'
    type?: 'PROTECT' | 'MUTE'
  }): void {
   ...
   * @desc void
   */
  public channels_select_box(options: {
    xmin?: number
    xmax?: number
    ymin?: number
    ymax?: number
   ...
   * @desc void
   */
  public channels_setting_disable(options: {
    mode?: 'TOGGLE' | 'DISABLE' | 'ENABLE' | 'INVERT'
    type?: 'PROTECT' | 'MUTE'
  }): void {
   ...
   * @desc void
   */
  public channels_setting_enable(options: {
    mode?: 'TOGGLE' | 'DISABLE' | 'ENABLE' | 'INVERT'
    type?: 'PROTECT' | 'MUTE'
  }): void {
   ...
   * @desc void
   */
  public channels_setting_toggle(options: {
    mode?: 'TOGGLE' | 'DISABLE' | 'ENABLE' | 'INVERT'
    type?: 'PROTECT' | 'MUTE'
  }): void {
   ...
   * @desc void
   */
  public keying_set_export(options: {
    filepath?: string
   ...
   * @desc void
   */
  public previewrange_set(options: {
    xmin?: number
    xmax?: number
    ymin?: number
    ymax?: number
