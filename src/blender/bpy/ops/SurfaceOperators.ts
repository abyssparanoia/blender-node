...
export class SurfaceOperators {
   ...
   * @desc void
   */
  public primitive_nurbs_surface_circle_add(options: {
    radius?: number
   ...
   * @desc void
   */
  public primitive_nurbs_surface_curve_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_surface_cylinder_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_surface_sphere_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_surface_surface_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_nurbs_surface_torus_add(options: {
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
