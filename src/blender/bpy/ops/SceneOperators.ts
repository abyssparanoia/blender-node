...
export class SceneOperators {
   ...
   * @desc void
   */
  public freestyle_alpha_modifier_add(options: {
    type?:
      | 'ALONG_STROKE'
      | 'CREASE_ANGLE'
      | 'CURVATURE_3D'
   ...
   * @desc void
   */
  public freestyle_color_modifier_add(options: {
    type?:
      | 'ALONG_STROKE'
      | 'CREASE_ANGLE'
      | 'CURVATURE_3D'
   ...
   * @desc void
   */
  public freestyle_geometry_modifier_add(options: {
    type?:
      | '2D_OFFSET'
      | '2D_TRANSFORM'
      | 'BACKBONE_STRETCHER'
   ...
   * @desc void
   */
  public freestyle_thickness_modifier_add(options: {
    type?:
      | 'ALONG_STROKE'
      | 'CALLIGRAPHY'
      | 'CREASE_ANGLE'
