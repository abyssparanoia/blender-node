...
export class WmOperators {
   ...
   * @desc void
   */
  public alembic_export(options: {
    filepath?: string
    hide_props_region?: boolean
    check_existing?: boolean
    filter_blender?: boolean
    filter_backup?: boolean
    ...
    filter_btx?: boolean
    filter_collada?: boolean
    filter_alembic?: boolean
    filter_usd?: boolean
    filter_folder?: boolean
    filter_blenlib?: boolean
    filemode?: number
    display_type?: 'DEFAULT' | 'LIST_VERTICAL' | 'LIST_HORIZONTAL' | 'THUMBNAIL'
    sort_method?: 'FILE_SORT_ALPHA' | 'FILE_SORT_EXTENSION' | 'FILE_SORT_TIME' | 'FILE_SORT_SIZE'
    start?: number
    end?: number
    xsamples?: number
    gsamples?: number
    ...
    sh_close?: number
    selected?: boolean
    renderable_only?: boolean
    visible_objects_only?: boolean
    flatten?: boolean
    uvs?: boolean
    packuv?: boolean
    normals?: boolean
    vcolors?: boolean
    face_sets?: boolean
    subdiv_schema?: boolean
    apply_subdiv?: boolean
    curves_as_mesh?: boolean
    compression_type?: 'OGAWA' | 'HDF5'
    global_scale?: number
    triangulate?: boolean
    quad_method?: 'BEAUTY' | 'FIXED' | 'FIXED_ALTERNATE' | 'SHORTEST_DIAGONAL'
    ngon_method?: 'BEAUTY' | 'FIXED' | 'FIXED_ALTERNATE' | 'SHORTEST_DIAGONAL'
    export_hair?: boolean
    export_particles?: boolean
    as_background_job?: boolean
  }): void {
  ...
  public alembic_import(options: {
    ...
    sort_method?: 'FILE_SORT_ALPHA' | 'FILE_SORT_EXTENSION' | 'FILE_SORT_TIME' | 'FILE_SORT_SIZE'
    scale?: number
    set_frame_range?: boolean
    validate_meshes?: boolean
    is_sequence?: boolean
    as_background_job?: boolean
  }): void {
  ...
  public collada_export(options: {
    ...
    display_type?: 'DEFAULT' | 'LIST_VERTICAL' | 'LIST_HORIZONTAL' | 'THUMBNAIL'
    sort_method?: 'FILE_SORT_ALPHA' | 'FILE_SORT_EXTENSION' | 'FILE_SORT_TIME' | 'FILE_SORT_SIZE'
    prop_bc_export_ui_section?: 'main' | 'geometry' | 'armature' | 'animation' | 'collada'
    apply_modifiers?: boolean
    export_mesh_type?: number
    export_mesh_type_selection?: 'view' | 'render'
    export_global_forward_selection?: 'X' | 'Y' | 'Z' | '-X' | '-Y' | '-Z'
    export_global_up_selection?: 'X' | 'Y' | 'Z' | '-X' | '-Y' | '-Z'
    apply_global_orientation?: boolean
    selected?: boolean
    include_children?: boolean
    include_armatures?: boolean
    include_shapekeys?: boolean
    deform_bones_only?: boolean
    include_animations?: boolean
    include_all_actions?: boolean
    export_animation_type_selection?: 'sample' | 'keys'
    sampling_rate?: number
    keep_smooth_curves?: boolean
    keep_keyframes?: boolean
    keep_flat_curves?: boolean
    active_uv_only?: boolean
    use_texture_copies?: boolean
    triangulate?: boolean
    use_object_instantiation?: boolean
    use_blender_profile?: boolean
    sort_by_name?: boolean
    export_object_transformation_type?: number
    export_object_transformation_type_selection?: 'matrix' | 'decomposed'
    export_animation_transformation_type?: number
    export_animation_transformation_type_selection?: 'matrix' | 'decomposed'
    open_sim?: boolean
    limit_precision?: boolean
    keep_bind_info?: boolean
  }): void {
   ...
   * @desc void
   */
  public context_collection_boolean_set(options: {
    data_path_iter?: string
    data_path_item?: string
   ...
   * @desc void
   */
  public context_modal_mouse(options: {
    data_path_iter?: string
    data_path_item?: string
    header_text?: string
    input_scale?: number
   ...
   * @desc void
   */
  public operator_preset_add(options: {
    name?: string
    remove_name?: boolean
    remove_active?: boolean
    operator?: string
  }): void {
   ...
   * @desc void
   */
  public previews_batch_clear(options: {
    files?: any
    directory?: string
    filter_blender?: boolean
    filter_folder?: boolean
   ...
   * @desc void
   */
  public previews_batch_generate(options: {
    files?: any
    directory?: string
    filter_blender?: boolean
    filter_folder?: boolean
   ...
   * @desc void
   */
  public properties_edit(options: {
    data_path?: string
    property?: string
    value?: string
    default?: string
    min?: number
    max?: number
    use_soft_limits?: boolean
    is_overridable_library?: boolean
    soft_min?: number
    soft_max?: number
    description?: string
    subtype?: string
   ...
   * @desc void
   */
  public radial_control(options: {
    data_path_primary?: string
    data_path_secondary?: string
    use_secondary?: string
    rotation_path?: string
    color_path?: string
    fill_color_path?: string
    fill_color_override_path?: string
    fill_color_override_test_path?: string
    zoom_path?: string
    image_id?: string
    secondary_tex?: boolean
  }): void {
   ...
   * @desc void
   */
  public recover_auto_save(options: {
    filepath?: string
    hide_props_region?: boolean
    filter_blender?: boolean
    filter_backup?: boolean
   ...
   * @desc void
   */
  public redraw_timer(options: {
    type?: 'DRAW' | 'DRAW_SWAP' | 'DRAW_WIN' | 'DRAW_WIN_SWAP' | 'ANIM_STEP' | 'ANIM_PLAY' | 'UNDO'
    iterations?: number
    time_limit?: number
  }): void {
   ...
   * @desc void
   */
  public save_as_mainfile(options: {
    filepath?: string
    hide_props_region?: boolean
    check_existing?: boolean
    filter_blender?: boolean
   ...
   * @desc void
   */
  public set_stereo_3d(options: {
    display_mode?: 'ANAGLYPH' | 'INTERLACE' | 'TIMESEQUENTIAL' | 'SIDEBYSIDE' | 'TOPBOTTOM'
    anaglyph_type?: 'RED_CYAN' | 'GREEN_MAGENTA' | 'YELLOW_BLUE'
    interlace_type?: 'ROW_INTERLEAVED' | 'COLUMN_INTERLEAVED' | 'CHECKERBOARD_INTERLEAVED'
    use_interlace_swap?: boolean
    use_sidebyside_crosseyed?: boolean
  }): void {
   ...
   * @desc void
   */
  public tool_set_by_index(options: {
    index?: number
    cycle?: boolean
    expand?: boolean
    as_fallback?: boolean
