...
export class TransformOperators {
  ...
  public bend(options: {
    ...
    snap_point?: [number, number, number]
    snap_align?: boolean
    snap_normal?: [number, number, number]
    gpencil_strokes?: boolean
    center_override?: [number, number, number]
   ...
   * @desc void
   */
  public edge_bevelweight(options: {
    value?: number
    snap?: boolean
    snap_target?: 'CLOSEST' | 'CENTER' | 'MEDIAN' | 'ACTIVE'
    snap_point?: [number, number, number]
   ...
   * @desc void
   */
  public mirror(options: {
    orient_type?: string
    orient_matrix?: [[number, number, number], [number, number, number], [number, number, number]]
    orient_matrix_type?: string
    constraint_axis?: [boolean, boolean, boolean]
    use_proportional_edit?: boolean
    proportional_edit_falloff?:
      | 'SMOOTH'
      | 'SPHERE'
   ...
   * @desc void
   */
  public shear(options: {
    value?: number
    orient_axis?: 'X' | 'Y' | 'Z'
    orient_axis_ortho?: 'X' | 'Y' | 'Z'
    orient_type?: string
    orient_matrix?: [[number, number, number], [number, number, number], [number, number, number]]
    orient_matrix_type?: string
    mirror?: boolean
  ...
  public transform(options: {
    ...
    orient_matrix?: [[number, number, number], [number, number, number], [number, number, number]]
    orient_matrix_type?: 'GLOBAL' | 'LOCAL' | 'NORMAL' | 'GIMBAL' | 'VIEW' | 'CURSOR'
    constraint_axis?: [boolean, boolean, boolean]
    mirror?: boolean
    use_proportional_edit?: boolean
    proportional_edit_falloff?:
