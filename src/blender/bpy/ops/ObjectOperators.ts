...
export class ObjectOperators {
   ...
   * @desc void
   */
  public align(options: {
    bb_quality?: boolean
    align_mode?: 'OPT_1' | 'OPT_2' | 'OPT_3'
    relative_to?: 'OPT_1' | 'OPT_2' | 'OPT_3' | 'OPT_4'
    align_axis?: ('X' | 'Y' | 'Z')[]
  }): void {
  ...
  public bake(options: {
    ...
    height?: number
    margin?: number
    use_selected_to_active?: boolean
    cage_extrusion?: number
    cage_object?: string
    normal_space?: 'OBJECT' | 'TANGENT'
    normal_r?: 'POS_X' | 'POS_Y' | 'POS_Z' | 'NEG_X' | 'NEG_Y' | 'NEG_Z'
    normal_g?: 'POS_X' | 'POS_Y' | 'POS_Z' | 'NEG_X' | 'NEG_Y' | 'NEG_Z'
    normal_b?: 'POS_X' | 'POS_Y' | 'POS_Z' | 'NEG_X' | 'NEG_Y' | 'NEG_Z'
    save_mode?: 'INTERNAL' | 'EXTERNAL'
    use_clear?: boolean
    use_cage?: boolean
    use_split_materials?: boolean
    use_automatic_name?: boolean
    uv_layer?: string
  }): void {
   ...
   * @desc void
   */
  public collection_instance_add(options: {
    name?: string
    collection?: string
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public data_transfer(options: {
    use_reverse_transfer?: boolean
    use_freeze?: boolean
    data_type?:
      | 'VGROUP_WEIGHTS'
      | 'BEVEL_WEIGHT_VERT'
    ...
    vert_mapping?:
      ...
      | 'POLYINTERP_NEAREST'
      | 'POLYINTERP_VNORPROJ'
    edge_mapping?: 'TOPOLOGY' | 'VERT_NEAREST' | 'NEAREST' | 'POLY_NEAREST' | 'EDGEINTERP_VNORPROJ'
    loop_mapping?:
      | 'TOPOLOGY'
      | 'NEAREST_NORMAL'
      | 'NEAREST_POLYNOR'
      ...
      | 'POLYINTERP_NEAREST'
      | 'POLYINTERP_LNORPROJ'
    poly_mapping?: 'TOPOLOGY' | 'NEAREST' | 'NORMAL' | 'POLYINTERP_PNORPROJ'
    use_auto_transform?: boolean
    use_object_transform?: boolean
    use_max_distance?: boolean
    max_distance?: number
    ray_radius?: number
    islands_precision?: number
   ...
   * @desc void
   */
  public datalayout_transfer(options: {
    modifier?: string
    data_type?:
      | 'VGROUP_WEIGHTS'
      | 'BEVEL_WEIGHT_VERT'
   ...
   * @desc void
   */
  public drop_named_image(options: {
    filepath?: string
   ...
   * @desc void
   */
  public duplicate_move_linked(options: {
    OBJECT_OT_duplicate?: OBJECT_OT_duplicate
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public gpencil_add(options: {
    radius?: number
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
    rotation?: [number, number, number]
    type?: 'EMPTY' | 'STROKE' | 'MONKEY'
  }): void {
   ...
   * @desc void
   */
  public gpencil_modifier_add(options: {
    type?:
      | 'DATA_TRANSFER'
      | 'MESH_CACHE'
      | 'MESH_SEQUENCE_CACHE'
   ...
   * @desc void
   */
  public lightprobe_add(options: {
    type?: 'CUBEMAP' | 'PLANAR' | 'GRID'
    radius?: number
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public link_to_collection(options: {
   ...
   * @desc void
   */
  public load_background_image(options: {
    filepath?: string
   ...
   * @desc void
   */
  public load_reference_image(options: {
    filepath?: string
    filter_image?: boolean
    filter_folder?: boolean
    view_align?: boolean
   ...
   * @desc void
   */
  public make_links_data(options: {
    type?: 'OBDATA' | 'MATERIAL' | 'ANIMATION' | 'GROUPS' | 'DUPLICOLLECTION' | 'MODIFIERS' | 'FONTS'
  }): void {
   ...
   * @desc void
   */
  public make_single_user(options: {
   ...
   * @desc void
   */
  public mode_set_with_submode(options: {
    mode?:
      | 'OBJECT'
      | 'EDIT'
      | 'POSE'
      ...
      | 'WEIGHT_GPENCIL'
    toggle?: boolean
    mesh_select_mode?: ('VERT' | 'EDGE' | 'FACE')[]
  }): void {
   ...
   * @desc void
   */
  public move_to_collection(options: {
    collection_index?: number
    is_new?: boolean
    new_collection_name?: string
  }): void {
   ...
   * @desc void
   */
  public multires_external_save(options: {
    filepath?: string
   ...
   * @desc void
   */
  public quadriflow_remesh(options: {
    use_paint_symmetry?: boolean
    use_preserve_sharp?: boolean
    use_preserve_boundary?: boolean
    use_mesh_curvature?: boolean
    preserve_paint_mask?: boolean
    smooth_normals?: boolean
    mode?: 'RATIO' | 'EDGE' | 'FACES'
    target_ratio?: number
   ...
   * @desc void
   */
  public randomize_transform(options: {
    random_seed?: number
    use_delta?: boolean
    use_loc?: boolean
   ...
   * @desc void
   */
  public select_linked(options: {
    extend?: boolean
    type?: 'OBDATA' | 'MATERIAL' | 'DUPGROUP' | 'PARTICLE' | 'LIBRARY' | 'LIBRARY_OBDATA'
  }): void {
   ...
   * @desc void
   */
  public shape_key_transfer(options: {
    mode?: 'OFFSET' | 'RELATIVE_FACE' | 'RELATIVE_EDGE'
    use_clamp?: boolean
  }): void {
   ...
   * @desc void
   */
  public transform_apply(options: {
    location?: boolean
    rotation?: boolean
    scale?: boolean
    properties?: boolean
   ...
   * @desc void
   */
  public vertex_group_invert(options: {
   ...
   * @desc void
   */
  public vertex_group_mirror(options: {
    mirror_weights?: boolean
    flip_group_names?: boolean
    all_groups?: boolean
    use_topology?: boolean
  }): void {
   ...
   * @desc void
   */
  public vertex_group_smooth(options: {
    group_select_mode?: string
    factor?: number
    repeat?: number
    expand?: number
