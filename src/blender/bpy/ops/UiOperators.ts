...
export class UiOperators {
   ...
   * @desc void
   */
  public eyedropper_driver(options: {
    mapping_type?: 'SINGLE_MANY' | 'DIRECT' | 'MATCH' | 'NONE_ALL' | 'NONE_SINGLE'
  }): void {
   ...
   * @desc void
   */
  public override_type_set_button(options: {
    all?: boolean
    type?: 'NOOP' | 'REPLACE' | 'DIFFERENCE' | 'FACTOR'
  }): void {
