...
export class GraphOperators {
  ...
  public duplicate_move(options: {
    GRAPH_OT_duplicate?: GRAPH_OT_duplicate
    TRANSFORM_OT_transform?: TRANSFORM_OT_transform
  }): void {
   ...
   * @desc void
   */
  public fmodifier_add(options: {
    type?: 'NULL' | 'GENERATOR' | 'FNGENERATOR' | 'ENVELOPE' | 'CYCLES' | 'NOISE' | 'LIMITS' | 'STEPPED'
    only_active?: boolean
  }): void {
   ...
   * @desc void
   */
  public interpolation_type(options: {
    type?:
      | 'CONSTANT'
      | 'LINEAR'
      | 'BEZIER'
   ...
   * @desc void
   */
  public paste(options: {
    offset?: 'START' | 'END' | 'RELATIVE' | 'NONE'
    merge?: 'MIX' | 'OVER_ALL' | 'OVER_RANGE' | 'OVER_RANGE_ALL'
    flipped?: boolean
  }): void {
   ...
   */
  public snap(options: {
    type?: 'CFRA' | 'VALUE' | 'NEAREST_FRAME' | 'NEAREST_SECOND' | 'NEAREST_MARKER' | 'HORIZONTAL'
  }): void {
  ...
  public sound_bake(options: {
    ...
    release?: number
    threshold?: number
    use_accumulate?: boolean
    use_additive?: boolean
    use_square?: boolean
    sthreshold?: number
  }): void {
