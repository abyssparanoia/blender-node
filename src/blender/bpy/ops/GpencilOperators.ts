...
export class GpencilOperators {
   ...
   * @desc void
   */
  public annotate(options: {
    mode?: 'DRAW' | 'DRAW_STRAIGHT' | 'DRAW_POLY' | 'ERASER'
    stroke?: string
  ...
  public convert(options: {
    type?: 'PATH' | 'CURVE' | 'POLY'
    use_normalize_weights?: boolean
    radius_multiplier?: number
    use_link_strokes?: boolean
    timing_mode?: 'NONE' | 'LINEAR' | 'FULL' | 'CUSTOMGAP'
    frame_range?: number
    start_frame?: number
    use_realtime?: boolean
    end_frame?: number
    gap_duration?: number
    gap_randomness?: number
    seed?: number
    use_timing_data?: boolean
  }): void {
  ...
  public draw(options: {
    ...
    stroke?: string
    wait_for_input?: boolean
    disable_straight?: boolean
    disable_fill?: boolean
    guide_last_angle?: number
  }): void {
  ...
  public duplicate_move(options: {
    GPENCIL_OT_duplicate?: GPENCIL_OT_duplicate
   ...
   * @desc void
   */
  public extrude_move(options: {
    GPENCIL_OT_extrude?: GPENCIL_OT_extrude
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public generate_weights(options: {
    mode?: 'NAME' | 'AUTO'
    armature?: 'DEFAULT'
    ratio?: number
    decay?: number
   ...
   * @desc void
   */
  public primitive(options: {
    edges?: number
    type?: 'BOX' | 'LINE' | 'POLYLINE' | 'CIRCLE' | 'ARC' | 'CURVE'
    wait_for_input?: boolean
  }): void {
   ...
   * @desc void
   */
  public stroke_merge(options: {
    mode?: 'STROKE' | 'POINT'
    back?: boolean
    additive?: boolean
    cyclic?: boolean
    clear_point?: boolean
    clear_stroke?: boolean
  }): void {
   ...
   * @desc void
   */
  public stroke_smooth(options: {
    repeat?: number
    factor?: number
    only_selected?: boolean
    smooth_position?: boolean
    smooth_thickness?: boolean
    smooth_strength?: boolean
    smooth_uv?: boolean
  }): void {
   ...
   * @desc void
   */
  public stroke_subdivide(options: {
    number_cuts?: number
    factor?: number
    repeat?: number
    only_selected?: boolean
