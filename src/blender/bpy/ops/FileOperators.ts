...
export class FileOperators {
   ...
   * @desc void
   */
  public find_missing_files(options: {
    find_all?: boolean
    directory?: string
   ...
   * @desc void
   */
  public unpack_all(options: {
    method?: 'USE_LOCAL' | 'WRITE_LOCAL' | 'USE_ORIGINAL' | 'WRITE_ORIGINAL' | 'KEEP' | 'REMOVE'
  }): void {
   ...
   * @desc void
   */
  public unpack_item(options: {
    method?: 'USE_LOCAL' | 'WRITE_LOCAL' | 'USE_ORIGINAL' | 'WRITE_ORIGINAL'
    id_name?: string
    id_type?: number
  }): void {
