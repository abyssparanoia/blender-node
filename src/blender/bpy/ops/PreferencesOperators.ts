...
export class PreferencesOperators {
   ...
   * @desc void
   */
  public addon_install(options: {
    overwrite?: boolean
    target?: 'DEFAULT' | 'PREFS'
    filepath?: string
   ...
   * @desc void
   */
  public app_template_install(options: {
    overwrite?: boolean
    filepath?: string
    filter_folder?: boolean
    filter_glob?: string
   ...
   * @desc void
   */
  public keyconfig_export(options: {
    all?: boolean
    filepath?: string
    filter_folder?: boolean
    filter_text?: boolean
   ...
   * @desc void
   */
  public keyconfig_import(options: {
    filepath?: string
    filter_folder?: boolean
    filter_text?: boolean
    filter_python?: boolean
   ...
   * @desc void
   */
  public studiolight_install(options: {
    files?: any
    directory?: string
    filter_folder?: boolean
    filter_glob?: string
    type?: 'MATCAP' | 'WORLD' | 'STUDIO'
  }): void {
