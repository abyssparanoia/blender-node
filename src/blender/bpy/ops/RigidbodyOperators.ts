...
export class RigidbodyOperators {
  ...
  public connect(options: {
    con_type?: 'FIXED' | 'POINT' | 'HINGE' | 'SLIDER' | 'PISTON' | 'GENERIC' | 'GENERIC_SPRING' | 'MOTOR'
    pivot_type?: 'CENTER' | 'ACTIVE' | 'SELECTED'
    connection_pattern?: 'SELECTED_TO_ACTIVE' | 'CHAIN_DISTANCE'
  }): void {
  ...
  public constraint_add(options: {
    type?: 'FIXED' | 'POINT' | 'HINGE' | 'SLIDER' | 'PISTON' | 'GENERIC' | 'GENERIC_SPRING' | 'MOTOR'
  }): void {
   ...
   * @desc void
   */
  public shape_change(options: {
    type?: 'BOX' | 'SPHERE' | 'CAPSULE' | 'CYLINDER' | 'CONE' | 'CONVEX_HULL' | 'MESH'
  }): void {
