...
export class ArmatureOperators {
   ...
   * @desc void
   */
  public armature_layers(options: {
    layers?: [
      boolean,
      boolean,
      boolean,
  ...
  public duplicate_move(options: {
    ARMATURE_OT_duplicate?: ARMATURE_OT_duplicate
   ...
   * @desc void
   */
  public extrude_forked(options: {
    ARMATURE_OT_extrude?: ARMATURE_OT_extrude
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
