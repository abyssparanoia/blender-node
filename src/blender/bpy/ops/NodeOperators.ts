...
export class NodeOperators {
   ...
   * @desc void
   */
  public add_and_link_node(options: {
    type?: string
    use_transform?: boolean
    settings?: any
    link_socket_index?: number
  }): void {
   ...
   * @desc void
   */
  public detach_translate_attach(options: {
    NODE_OT_detach?: NODE_OT_detach
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
    NODE_OT_attach?: NODE_OT_attach
  }): void {
  ...
  public duplicate_move(options: {
    NODE_OT_duplicate?: NODE_OT_duplicate
    NODE_OT_translate_attach?: NODE_OT_translate_attach
  }): void {
   ...
   * @desc void
   */
  public duplicate_move_keep_inputs(options: {
    NODE_OT_duplicate?: NODE_OT_duplicate
    NODE_OT_translate_attach?: NODE_OT_translate_attach
  }): void {
   ...
   * @desc void
   */
  public move_detach_links(options: {
    NODE_OT_links_detach?: NODE_OT_links_detach
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
    NODE_OT_insert_offset?: NODE_OT_insert_offset
  }): void {
   ...
   * @desc void
   */
  public move_detach_links_release(options: {
    NODE_OT_links_detach?: NODE_OT_links_detach
    NODE_OT_translate_attach?: NODE_OT_translate_attach
  }): void {
   ...
   * @desc void
   */
  public select_link_viewer(options: {
    NODE_OT_select?: NODE_OT_select
    NODE_OT_link_viewer?: NODE_OT_link_viewer
  }): void {
   ...
   * @desc void
   */
  public translate_attach(options: {
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
    NODE_OT_attach?: NODE_OT_attach
    NODE_OT_insert_offset?: NODE_OT_insert_offset
  }): void {
   ...
   * @desc void
   */
  public translate_attach_remove_on_cancel(options: {
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
    NODE_OT_attach?: NODE_OT_attach
    NODE_OT_insert_offset?: NODE_OT_insert_offset
  }): void {
