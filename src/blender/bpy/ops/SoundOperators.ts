...
export class SoundOperators {
  ...
  public mixdown(options: {
    ...
    accuracy?: number
    container?: 'AC3' | 'FLAC' | 'MATROSKA' | 'MP2' | 'MP3' | 'OGG' | 'WAV'
    codec?: 'AAC' | 'AC3' | 'FLAC' | 'MP2' | 'MP3' | 'PCM' | 'VORBIS'
    format?: 'U8' | 'S16' | 'S24' | 'S32' | 'F32' | 'F64'
    bitrate?: number
