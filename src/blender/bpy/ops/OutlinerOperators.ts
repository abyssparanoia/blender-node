...
export class OutlinerOperators {
   ...
   * @desc void
   */
  public animdata_operation(options: {
    type?: 'CLEAR_ANIMDATA' | 'SET_ACT' | 'CLEAR_ACT' | 'REFRESH_DRIVERS' | 'CLEAR_DRIVERS'
  }): void {
   ...
   * @desc void
   */
  public object_operation(options: {
    type?:
      | 'SELECT'
      | 'DESELECT'
      | 'SELECT_HIERARCHY'
