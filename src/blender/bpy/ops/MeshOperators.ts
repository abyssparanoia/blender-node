...
export class MeshOperators {
   ...
   * @desc void
   */
  public average_normals(options: {
    average_type?: 'CUSTOM_NORMAL' | 'FACE_AREA' | 'CORNER_ANGLE'
    weight?: number
    threshold?: number
  }): void {
  ...
  public bevel(options: {
    ...
    profile?: number
    vertex_only?: boolean
    clamp_overlap?: boolean
    loop_slide?: boolean
    mark_seam?: boolean
    mark_sharp?: boolean
    material?: number
    harden_normals?: boolean
    face_strength_mode?: 'NONE' | 'NEW' | 'AFFECTED' | 'ALL'
    miter_outer?: 'SHARP' | 'PATCH' | 'ARC'
    miter_inner?: 'SHARP' | 'ARC'
    spread?: number
    use_custom_profile?: boolean
    vmesh_method?: 'ADJ' | 'CUTOFF'
    release_confirm?: boolean
  }): void {
   ...
   * @desc void
   */
  public bisect(options: {
    plane_co?: [number, number, number]
    plane_no?: [number, number, number]
    use_fill?: boolean
    clear_inner?: boolean
    clear_outer?: boolean
    threshold?: number
   ...
   * @desc void
   */
  public bridge_edge_loops(options: {
    type?: 'SINGLE' | 'CLOSED' | 'PAIRS'
    use_merge?: boolean
    merge_factor?: number
    twist_offset?: number
    number_cuts?: number
    interpolation?: 'LINEAR' | 'PATH' | 'SURFACE'
    smoothness?: number
    profile_shape_factor?: number
    profile_shape?: 'SMOOTH' | 'SPHERE' | 'ROOT' | 'INVERSE_SQUARE' | 'SHARP' | 'LINEAR'
  }): void {
   ...
   * @desc void
   */
  public convex_hull(options: {
    delete_unused?: boolean
    use_existing_faces?: boolean
    make_holes?: boolean
    join_triangles?: boolean
   ...
   * @desc void
   */
  public decimate(options: {
    ratio?: number
    use_vertex_group?: boolean
    vertex_group_factor?: number
    invert_vertex_group?: boolean
    use_symmetry?: boolean
    symmetry_axis?: 'X' | 'Y' | 'Z'
  }): void {
   ...
   * @desc void
   */
  public dissolve_limited(options: {
    angle_limit?: number
    use_dissolve_boundaries?: boolean
   ...
   * @desc void
   */
  public duplicate_move(options: {
    MESH_OT_duplicate?: MESH_OT_duplicate
   ...
   * @desc void
   */
  public extrude_context_move(options: {
    MESH_OT_extrude_context?: MESH_OT_extrude_context
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public extrude_edges_move(options: {
    MESH_OT_extrude_edges_indiv?: MESH_OT_extrude_edges_indiv
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public extrude_faces_move(options: {
    MESH_OT_extrude_faces_indiv?: MESH_OT_extrude_faces_indiv
   ...
   * @desc void
   */
  public extrude_region_move(options: {
   ...
   * @desc void
   */
  public extrude_region_shrink_fatten(options: {
    MESH_OT_extrude_region?: MESH_OT_extrude_region
    TRANSFORM_OT_shrink_fatten?: TRANSFORM_OT_shrink_fatten
  }): void {
   ...
   * @desc void
   */
  public extrude_vertices_move(options: {
    MESH_OT_extrude_verts_indiv?: MESH_OT_extrude_verts_indiv
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
  ...
  public inset(options: {
    use_boundary?: boolean
    use_even_offset?: boolean
    use_relative_offset?: boolean
    use_edge_rail?: boolean
    thickness?: number
    depth?: number
    use_outset?: boolean
    use_select_inset?: boolean
    use_individual?: boolean
    use_interpolate?: boolean
    release_confirm?: boolean
  }): void {
   ...
   * @desc void
   */
  public intersect(options: {
    mode?: 'SELECT' | 'SELECT_UNSELECT'
    separate_mode?: 'ALL' | 'CUT' | 'NONE'
    threshold?: number
  }): void {
   ...
   * @desc void
   */
  public intersect_boolean(options: {
   ...
   * @desc void
   */
  public knife_tool(options: {
    use_occlude_geometry?: boolean
   ...
   * @desc void
   */
  public loopcut_slide(options: {
    MESH_OT_loopcut?: MESH_OT_loopcut
    TRANSFORM_OT_edge_slide?: TRANSFORM_OT_edge_slide
  }): void {
   ...
   * @desc void
   */
  public offset_edge_loops_slide(options: {
    MESH_OT_offset_edge_loops?: MESH_OT_offset_edge_loops
    TRANSFORM_OT_edge_slide?: TRANSFORM_OT_edge_slide
  }): void {
   ...
   * @desc void
   */
  public paint_mask_extract(options: {
    mask_threshold?: number
    add_boundary_loop?: boolean
    smooth_iterations?: number
    apply_shrinkwrap?: boolean
    add_solidify?: boolean
  }): void {
   ...
   * @desc void
   */
  public point_normals(options: {
    mode?: 'COORDINATES' | 'MOUSE'
    invert?: boolean
    align?: boolean
    target_location?: [number, number, number]
    spherize?: boolean
    spherize_strength?: number
  }): void {
  ...
  public poke(options: {
    offset?: number
    use_relative_offset?: boolean
    center_mode?: 'MEDIAN_WEIGHTED' | 'MEDIAN' | 'BOUNDS'
  }): void {
   ...
   * @desc void
   */
  public polybuild_delete_at_cursor(options: {
    mirror?: boolean
    use_proportional_edit?: boolean
    proportional_edit_falloff?:
      ...
      | 'CONSTANT'
      | 'RANDOM'
    proportional_size?: number
    use_proportional_connected?: boolean
    use_proportional_projected?: boolean
    release_confirm?: boolean
    use_accurate?: boolean
  }): void {
   ...
   * @desc void
   */
  public polybuild_extrude_at_cursor_move(options: {
    MESH_OT_polybuild_transform_at_cursor?: MESH_OT_polybuild_transform_at_cursor
    MESH_OT_extrude_edges_indiv?: MESH_OT_extrude_edges_indiv
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public polybuild_face_at_cursor(options: {
    create_quads?: boolean
    mirror?: boolean
    use_proportional_edit?: boolean
    proportional_edit_falloff?:
      | 'SMOOTH'
   ...
   * @desc void
   */
  public polybuild_face_at_cursor_move(options: {
    MESH_OT_polybuild_face_at_cursor?: MESH_OT_polybuild_face_at_cursor
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public polybuild_split_at_cursor(options: {
    mirror?: boolean
    use_proportional_edit?: boolean
    proportional_edit_falloff?:
      | 'SMOOTH'
   ...
   * @desc void
   */
  public polybuild_split_at_cursor_move(options: {
    MESH_OT_polybuild_split_at_cursor?: MESH_OT_polybuild_split_at_cursor
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public polybuild_transform_at_cursor_move(options: {
    MESH_OT_polybuild_transform_at_cursor?: MESH_OT_polybuild_transform_at_cursor
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public primitive_circle_add(options: {
    vertices?: number
    radius?: number
    fill_type?: 'NOTHING' | 'NGON' | 'TRIFAN'
    calc_uvs?: boolean
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
   ...
   * @desc void
   */
  public primitive_cone_add(options: {
    vertices?: number
    radius1?: number
    radius2?: number
    depth?: number
    end_fill_type?: 'NOTHING' | 'NGON' | 'TRIFAN'
    calc_uvs?: boolean
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_cube_add(options: {
    size?: number
    calc_uvs?: boolean
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
   ...
   * @desc void
   */
  public primitive_cube_add_gizmo(options: {
    calc_uvs?: boolean
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
   ...
   * @desc void
   */
  public primitive_cylinder_add(options: {
    vertices?: number
    radius?: number
    depth?: number
    end_fill_type?: 'NOTHING' | 'NGON' | 'TRIFAN'
   ...
   * @desc void
   */
  public primitive_grid_add(options: {
   ...
   * @desc void
   */
  public primitive_ico_sphere_add(options: {
    subdivisions?: number
    radius?: number
    calc_uvs?: boolean
    enter_editmode?: boolean
   ...
   * @desc void
   */
  public primitive_monkey_add(options: {
    size?: number
    calc_uvs?: boolean
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
   ...
   * @desc void
   */
  public primitive_plane_add(options: {
    size?: number
    calc_uvs?: boolean
    enter_editmode?: boolean
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
   ...
   * @desc void
   */
  public primitive_torus_add(options: {
    align?: 'WORLD' | 'VIEW' | 'CURSOR'
    location?: [number, number, number]
    rotation?: [number, number, number]
    major_segments?: number
    minor_segments?: number
    mode?: 'MAJOR_MINOR' | 'EXT_INT'
    major_radius?: number
    minor_radius?: number
    abso_major_rad?: number
    abso_minor_rad?: number
    generate_uvs?: boolean
  }): void {
   ...
   * @desc void
   */
  public primitive_uv_sphere_add(options: {
    segments?: number
    ring_count?: number
    radius?: number
    calc_uvs?: boolean
   ...
   * @desc void
   */
  public quads_convert_to_tris(options: {
   ...
   * @desc void
   */
  public rip_edge_move(options: {
    MESH_OT_rip_edge?: MESH_OT_rip_edge
    TRANSFORM_OT_translate?: TRANSFORM_OT_translate
  }): void {
   ...
   * @desc void
   */
  public select_axis(options: {
    orientation?: 'GLOBAL' | 'LOCAL' | 'NORMAL' | 'GIMBAL' | 'VIEW' | 'CURSOR'
    sign?: 'POS' | 'NEG' | 'ALIGN'
    axis?: 'X' | 'Y' | 'Z'
    threshold?: number
  }): void {
   ...
   * @desc void
   */
  public select_face_by_sides(options: {
    number?: number
   ...
   * @desc void
   */
  public select_linked_pick(options: {
    deselect?: boolean
    delimit?: ('NORMAL' | 'MATERIAL' | 'SEAM' | 'SHARP' | 'UV')[]
  }): void {
   ...
   * @desc void
   */
  public select_mode(options: {
    use_extend?: boolean
    use_expand?: boolean
    type?: 'VERT' | 'EDGE' | 'FACE'
    action?: 'DISABLE' | 'ENABLE' | 'TOGGLE'
  }): void {
   ...
   * @desc void
   */
  public select_non_manifold(options: {
    extend?: boolean
    use_wire?: boolean
    use_boundary?: boolean
    use_multi_face?: boolean
    use_non_contiguous?: boolean
    use_verts?: boolean
  }): void {
   ...
   * @desc void
   */
  public shortest_path_pick(options: {
    edge_mode?: 'SELECT' | 'SEAM' | 'SHARP' | 'CREASE' | 'BEVEL' | 'FREESTYLE'
    use_face_step?: boolean
    use_topology_distance?: boolean
    use_fill?: boolean
    skip?: number
    nth?: number
    offset?: number
   ...
   * @desc void
   */
  public shortest_path_select(options: {
    edge_mode?: 'SELECT' | 'SEAM' | 'SHARP' | 'CREASE' | 'BEVEL' | 'FREESTYLE'
    use_face_step?: boolean
    use_topology_distance?: boolean
    use_fill?: boolean
   ...
   * @desc void
   */
  public sort_elements(options: {
    type?: 'VIEW_ZAXIS' | 'VIEW_XAXIS' | 'CURSOR_DISTANCE' | 'MATERIAL' | 'SELECTED' | 'RANDOMIZE' | 'REVERSE'
  ...
  public spin(options: {
    ...
    dupli?: boolean
    angle?: number
    use_auto_merge?: boolean
    use_normal_flip?: boolean
    center?: [number, number, number]
    axis?: [number, number, number]
  }): void {
   ...
   * @desc void
   */
  public subdivide(options: {
    number_cuts?: number
    smoothness?: number
    ngon?: boolean
    quadcorner?: 'INNERVERT' | 'PATH' | 'STRAIGHT_CUT' | 'FAN'
    fractal?: number
    fractal_along_normal?: number
    seed?: number
  }): void {
   ...
   * @desc void
   */
  public subdivide_edgering(options: {
    number_cuts?: number
    interpolation?: 'LINEAR' | 'PATH' | 'SURFACE'
    smoothness?: number
    profile_shape_factor?: number
   ...
   * @desc void
   */
  public symmetrize(options: {
    direction?: 'NEGATIVE_X' | 'POSITIVE_X' | 'NEGATIVE_Y' | 'POSITIVE_Y' | 'NEGATIVE_Z' | 'POSITIVE_Z'
    threshold?: number
  }): void {
   ...
   * @desc void
   */
  public tris_convert_to_quads(options: {
    face_threshold?: number
    shape_threshold?: number
    uvs?: boolean
    vcols?: boolean
   ...
   * @desc void
   */
  public vertices_smooth(options: {
    factor?: number
    repeat?: number
    xaxis?: boolean
    yaxis?: boolean
   ...
   * @desc void
   */
  public vertices_smooth_laplacian(options: {
    repeat?: number
    lambda_factor?: number
    lambda_border?: number
    use_x?: boolean
    use_y?: boolean
    use_z?: boolean
