...
export class UvOperators {
   ...
   * @desc void
   */
  public cylinder_project(options: {
    direction?: 'VIEW_ON_EQUATOR' | 'VIEW_ON_POLES' | 'ALIGN_TO_OBJECT'
    align?: 'POLAR_ZX' | 'POLAR_ZY'
    radius?: number
    correct_aspect?: boolean
    clip_to_bounds?: boolean
    scale_to_bounds?: boolean
   ...
   * @desc void
   */
  public lightmap_pack(options: {
    PREF_CONTEXT?: 'SEL_FACES' | 'ALL_FACES'
    PREF_PACK_IN_ONE?: boolean
    PREF_NEW_UVLAYER?: boolean
    PREF_APPLY_IMAGE?: boolean
    PREF_IMG_PX_SIZE?: number
    PREF_BOX_DIV?: number
    PREF_MARGIN_DIV?: number
  }): void {
   ...
   * @desc void
   */
  public project_from_view(options: {
    orthographic?: boolean
    camera_bounds?: boolean
    correct_aspect?: boolean
    clip_to_bounds?: boolean
    scale_to_bounds?: boolean
  }): void {
   ...
   * @desc void
   */
  public stitch(options: {
    use_limit?: boolean
    snap_islands?: boolean
    limit?: number
    static_island?: number
    active_object_index?: number
    midpoint_snap?: boolean
    clear_seams?: boolean
    mode?: 'VERTEX' | 'EDGE'
    stored_mode?: 'VERTEX' | 'EDGE'
    selection?: any
    objects_selection_count?: [number, number, number, number, number, number]
  }): void {
   ...
   * @desc void
   */
  public unwrap(options: {
    method?: 'ANGLE_BASED' | 'CONFORMAL'
    fill_holes?: boolean
    correct_aspect?: boolean
    use_subsurf_data?: boolean
    margin?: number
  }): void {
